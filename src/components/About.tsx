    ...
    <section id="about" aria-labelledby="about-title" className="py-28 px-6 bg-primary/35">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="mt-16"
        >
          <a href="./outside-work/" className="group flex items-center justify-between gap-6 rounded-3xl border border-cream/10 bg-surface/70 p-6 transition-colors hover:border-accent/40 hover:bg-accent/5">
            <div><p className="text-sm font-semibold uppercase tracking-[0.2em] text-secondary">Personal context</p><h3 className="mt-2 text-2xl font-bold text-cream">Climbing, skiing, and community</h3><p className="mt-2 text-cream/60">A short look at what keeps me curious outside of engineering.</p></div>
