...
export const knowledgeGraph: Record<string, KnowledgeNode> = {
  ...
  'arc-teryx': { id: 'arc-teryx', label: "Arc'teryx", type: 'work', summary: 'Retail labor allocation models built with a data science project team.', connections: ['connor', 'forecasting', 'databricks', 'python', 'machine-learning'] },
